...
<html lang="en">
  ...
  <body style="background-image:url(jj-ying-236821-unsplash.jpg) ;background-size:cover;background-attachment:fixed">	
	...
	<div class="col-lg-4"  style="background-color:rgba(230,230,0,0.3);height:150px;width:800px;margin-left:300px">
	<center>
	<h2>Time Table Details </h2><form action="timetable.php" method="post"style="width:600px;">
	<p class="form-inline"><select class="form-control" name="t1" >
		...
		<option value="afternoon ">After Noon Slot</option>
		<option value="evening ">Evening Slot</option>
		
	</select>
		<select class="form-control" name="t3" >
		<option disabled >Select Time Duration</option>
	...
	<button name="t4" value='<?php echo($se);?>'class="btn btn-warning" >Submit</button>
	</form></p></center>
	
	</center>
	</div><br><br>
	<center><table class="table table-bordered" style="height:100px;width:500px;font-weight:bold;background-color:rgba(220,220,220,0.7);">
			<tr><th>Day</th><th>Time Slot</th><th>Time Duration</th><th>Cancel </th></tr>
...
$data=mysqli_query($con,$sql);
 ...
 while($row=mysqli_fetch_assoc($data))
		
	{
		...
		<td><form action="cancel.php" method="post"><button name="t1" value='<?php echo($a);?>' >Cancel</button></td></tr>
			<?php			
		}		
